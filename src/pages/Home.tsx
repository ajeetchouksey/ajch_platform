...
const whyCards = [
  {
    ...
    glow: 'from-violet-500/5',
    label: 'Practitioner-built',
    body: '18+ years designing AI and cloud systems in production. Every resource here fills a gap I hit on a real project — not a syllabus requirement.',
  },
  {
    icon: Users,
    accent: 'text-blue-400',
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-start gap-5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <blockquote className="text-sm text-slate-400 leading-relaxed italic border-l-2 border-violet-600/40 pl-3 mb-4 max-w-2xl">
              "Everything on this platform was a personal note first — something I needed to understand, a gap I couldn't find filled anywhere else.
              I published them because the community taught me everything I know. Sharing back is the least I can do."
            </blockquote>
