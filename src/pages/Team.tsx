...
const orchestrator: AgentData = {
  ...
  deliveries: [
    ...
    { version: 'v2.4', label: 'Issue Gate workflow — Product Manager gating every feature before implementation', type: 'minor' },
    { version: 'v2.5', label: 'Study specialist routing: Exam Coach, Devil\u2019s Advocate, Performance Analyzer, Learning Analytics, Scenario Engineer', type: 'minor' },
  ],
};
...
export const l1Agents: AgentData[] = [ // eslint-disable-line react-refresh/only-export-components
  {
    ...
    deliveries: [
      ...
      { version: 'v3.2', label: 'Platform Docs agent wiring + lib/types/scripts ownership to Platform Dev Expert', type: 'minor' },
    ],
    subAgents: [
      {
        id: 'routing',
  ...
  },
  {
    ...
    subAgents: [
      ...
      },
      {
        ...
        owns: 'content/blog/ (ajch_aaryaai_blogs repo)',
    ...
    subAgents: [
      {
        ...
        owns: 'content/skillup/{examId}/questions/ (ajch_skillup repo)',
      ...
      },
      {
        ...
        owns: 'content/skillup/{examId}/notes/ (ajch_skillup repo)',
  ...
  },
  {
    ...
    subAgents: [
      ...
      },
      {
        id: 'exam-coach',
        name: 'Exam Coach',
        role: 'Mock Exam Specialist',
        description: 'Delivers timed mock exam sessions from the question bank. Scores and debriefs — read-only.',
        owns: 'no disk write — read-only',
        tools: 'read only',
        icon: Award,
        isNew: true,
      ...
      },
      {
        ...
        role: 'Adversarial Teaching',
        description: 'Presents wrong-but-convincing arguments and forces the student to find and rebut the flaw.',
        owns: 'no disk write — conversational only',
        tools: 'read only',
        icon: Brain,
        isNew: true,
      ...
      },
      {
        ...
        role: 'Gap Analysis',
        description: 'Reads question bank and session data to identify weak domains, distractor patterns, and remediation priorities.',
        owns: 'no disk write — read-only',
        tools: 'read only',
        icon: TrendingUp,
        isNew: true,
      ...
      },
      {
        ...
        description: 'Produces domain coverage heatmaps, difficulty distributions, tag frequency reports, and predicted readiness curves.',
        owns: 'no disk write — read-only',
        tools: 'read only',
        icon: Layers,
        isNew: true,
      ...
      {
        id: 'scenario-engineer',
        name: 'Scenario Engineer',
        role: 'Scenario Specialist',
        description: 'Creates RichScenario v2.0 JSON files for any exam. Writes to content/skillup/{examId}/scenarios/ and bumps contentVersion.',
        owns: 'content/skillup/{examId}/scenarios/ (ajch_skillup repo)',
        tools: 'read, edit (scenarios/ only)',
        icon: ListChecks,
        isNew: true,
...
const devopsAgent: AgentData = {
  ...
  deliveries: [
    ...
    { version: 'v1.2', label: 'Content-health workflow + Mermaid diagram validation gate', type: 'minor' },
    { version: 'v1.3', label: 'New study-specialist agent .md versioning (Exam Coach, Devil\u2019s Advocate, Performance Analyzer, Learning Analytics, Scenario Engineer)', type: 'minor' },
  ],
};
