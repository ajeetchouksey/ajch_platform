  ...
  },
  {
    ...
    subAgents: [
      ...
      },
      {
        ...
        description: 'Creates RichScenario v2.0 JSON files for any exam. Writes to public/content/skillup/{examId}/scenarios/ and bumps contentVersion.',
        owns: 'public/content/skillup/*/scenarios/',
