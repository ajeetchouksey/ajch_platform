        ...
        <div className="flex items-center h-14 px-6 w-full overflow-x-clip">
          ...
          >
            <img
              ...
              style={{ height: 'clamp(24px, 2.8vw, 32px)', width: 'auto' }}
            />
            <span
              className="text-slate-500 font-medium tracking-[0.08em] hidden sm:block select-none"
            ...
            <div className="max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                  <img src="/logo-mono-white.svg" alt="AaryaAI" style={{ height: '18px', width: 'auto', opacity: 0.9 }} />
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pt-1">
                <p className="text-[10px] text-slate-700">© 2026 AaryaAI · MIT License · Built in public</p>
