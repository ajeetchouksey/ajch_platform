...
description: Read-only analyst for exam performance gaps. Reads the question bank and session data to identify weak domains, distractor patterns, and remediation priorities. Never writes files.
