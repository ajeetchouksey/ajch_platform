...
description: React component scaffolding specialist for Aarya — My AI Learning Hub. Use this agent to create and modify page components and domain components using ONLY src/components/ui/ primitives. Never writes raw Tailwind badge/card/stat patterns.
