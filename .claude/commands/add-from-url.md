...
```
/add-from-url Add content from: https://docs.anthropic.com/en/docs/...
/add-from-url Update D3 notes with info from: [URL]
/add-from-url Generate 5 questions from: [URL]
```
