...
description: >
  Creates RichScenario v2.0 JSON files for any exam. Writes to
  public/content/skillup/{examId}/scenarios/ only and bumps contentVersion
  in index.json after every write.
